    ...
    <header className="lg:sticky lg:top-0 lg:flex lg:max-h-screen lg:w-1/2 lg:flex-col lg:justify-between lg:py-24">
        ...
        <ul class="mt-16 w-max">
          <li className={activeSubtitle === 1 ? "text-red-800" : ""}>
            <a class="group flex items-center py-3" href="#about">
              ...
              ></span>
              <span
                class={`${activeSubtitle === 1 ? "w-16 text-white" : "w-8 "
          ...
          <li>
            <a class="group flex items-center py-3" href="#skills">
              <span
                class={`${activeSubtitle === 2
                  ? "w-16 text-white bg-white"
                  : "w-8 bg-slate-600"
                  } nav-indicator mr-4 h-px   transition-all group-hover:w-16 group-hover:bg-slate-200 group-focus-visible:w-16 group-focus-visible:bg-slate-200 motion-reduce:transition-none`}
              ></span>
              <span
                class={`${activeSubtitle === 2 ? "w-16 text-white" : "w-8 "
                  } nav-text text-xs font-bold uppercase tracking-widest  group-hover:text-slate-200 group-focus-visible:text-slate-200`}
              >
                Skills
              </span>
          ...
          <li>
            <a class="group flex items-center py-3" href="#experience">
              <span
                class={`${activeSubtitle === 3
                  ? "w-16 text-white bg-white"
                  : "w-8 bg-slate-600"
                  } nav-indicator mr-4 h-px   transition-all group-hover:w-16 group-hover:bg-slate-200 group-focus-visible:w-16 group-focus-visible:bg-slate-200 motion-reduce:transition-none`}
              ></span>
              <span
                class={`${activeSubtitle === 3 ? "w-16 text-white" : "w-8 "
                  } nav-text text-xs font-bold uppercase tracking-widest  group-hover:text-slate-200 group-focus-visible:text-slate-200`}
              >
                Experience
              </span>
          ...
          <li>
            <a class="group flex items-center py-3 active" href="#projects">
              <span
                class={`${activeSubtitle === 4
                  ? "w-16 text-white bg-white"
                  : "w-8 bg-slate-600"
                  } nav-indicator mr-4 h-px   transition-all group-hover:w-16 group-hover:bg-slate-200 group-focus-visible:w-16 group-focus-visible:bg-slate-200 motion-reduce:transition-none`}
              ></span>
              <span
                class={`${activeSubtitle === 4 ? "w-16 text-white" : "w-8 "
                  } nav-text text-xs font-bold uppercase tracking-widest  group-hover:text-slate-200 group-focus-visible:text-slate-200`}
              >
                Projects
              </span>
          ...
          <li>
            <a class="group flex items-center py-3 active" href="#contact">
              <span
                class={`${activeSubtitle === 5
                  ? "w-16 text-white bg-white"
                  : "w-8 bg-slate-600"
                  } nav-indicator mr-4 h-px   transition-all group-hover:w-16 group-hover:bg-slate-200 group-focus-visible:w-16 group-focus-visible:bg-slate-200 motion-reduce:transition-none`}
              ></span>
              <span
                class={`${activeSubtitle === 5 ? "w-16 text-white" : "w-8 "
                  } nav-text text-xs font-bold uppercase tracking-widest  group-hover:text-slate-200 group-focus-visible:text-slate-200`}
              >
                Contact
              </span>
      ...
      <ul class="ml-1 mt-8 flex items-center" aria-label="Social media">
        ...
        <li class="mr-5 text-xs shrink-0">
          <a
            class="block hover:text-slate-200"
            href="https://www.linkedin.com/in/tigstu-deme-51a58a302/"
            target="_blank"
            rel="noreferrer noopener"
          ...
          >
            ...
            <svg
              xmlns="https://www.linkedin.com/in/tigstu-deme-51a58a302/"
              viewBox="0 0 24 24"
              fill="currentColor"
              class="h-6 w-6"
              aria-hidden="true"
